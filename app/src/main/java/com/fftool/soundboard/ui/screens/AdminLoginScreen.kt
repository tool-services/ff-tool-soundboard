...
fun AdminLoginScreen(
    ...
    Column(
        ...
        TopAppBar(
            title = { Text("Admin Access", color = TextPrimary) },
            navigationIcon = {
        ...
        Column(
            ...
            Text(
                text = "Enter administrator credentials",
                fontSize = 14.sp,
                color = TextSecondary,
            ...
            OutlinedTextField(
                ...
                keyboardActions = KeyboardActions(
                    onDone = {
                        ...
                        validate(username, password, prefs, onLoginSuccess) { error = it }
                    }
                )
            )
...
private fun validate(
    ...
    when {
        ...
        username == prefs.adminUsername && password == prefs.adminPassword -> {
            onSuccess()
        }
        else -> {
